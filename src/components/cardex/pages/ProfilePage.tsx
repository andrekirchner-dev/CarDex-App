...
const ProfilePage = () => (
  <div>
    ...
    <div className="mx-auto mb-3" style={{
      ...
      background: "linear-gradient(135deg, #E7363C, #FCAB20)", padding: 2,
    }}>
      <div className="w-full h-full rounded-full flex items-center justify-center" style={{ background: "#12121A", fontSize: 32 }}>
        🃏
      </div>
    </div>

    <div className="text-center" style={{ fontFamily: "var(--font-display)", fontSize: 32, letterSpacing: "0.04em", color: "#fff" }}>
      CARD MASTER
    </div>
    <div className="text-center mb-4" style={{ fontFamily: "var(--font-tech)", fontSize: 10, letterSpacing: "0.15em", color: "rgba(255,255,255,0.3)", textTransform: "uppercase" }}>
      Pro Collector · Since 2021
    </div>

    {/* Stats Grid */}
    <div className="grid grid-cols-2 gap-[6px] mb-[14px]">
      {[
        { key: "Total Cards", val: "127" },
        { key: "Graded Cards", val: "23" },
        { key: "Collections", val: "14" },
        { key: "Trades Done", val: "38" },
      ].map((s) => (
        <div key={s.key} className="rounded-[8px] p-[9px]" style={{ background: "rgba(255,255,255,0.03)", border: "1px solid rgba(255,255,255,0.07)" }}>
    ...
    {/* Plan Banner */}
    <div className="relative overflow-hidden rounded-[14px] p-[18px] mb-[10px]" style={{
      background: "linear-gradient(135deg, #3E446E 0%, #2a2050 100%)",
      border: "1px solid rgba(252,171,32,0.2)",
    }}>
      <div className="absolute -right-2 -top-3" style={{
        fontFamily: "var(--font-display)", fontSize: 80, color: "rgba(252,171,32,0.06)", letterSpacing: "0.1em",
      }}>PAID</div>
      <div style={{ fontFamily: "var(--font-display)", fontSize: 26, color: "#FCAB20", letterSpacing: "0.04em", marginBottom: 4 }}>
        PRO COLLECTOR
      </div>
      <div style={{ fontFamily: "var(--font-tech)", fontSize: 10, color: "rgba(255,255,255,0.4)", letterSpacing: "0.06em", marginBottom: 14 }}>
        Unlimited scans, priority grading, trade insights
      </div>
      {[
        { key: "Plan", val: "Annual Pro" },
        { key: "Renewal", val: "Mar 2026" },
        { key: "Scans Left", val: "Unlimited" },
      ].map((r) => (
    ...
    <div className="rounded-[16px] p-[14px]" style={{ background: "#1C1C28", border: "1px solid rgba(255,255,255,0.07)" }}>
      {settings.map((s, i) => (
        <div key={s} className="flex items-center justify-between cursor-pointer" style={{
          padding: "11px 0",
          borderBottom: i < settings.length - 1 ? "1px solid rgba(255,255,255,0.07)" : "none",
        }}>
